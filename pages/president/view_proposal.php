...
/* Show Review button only if pending on President */
$showReviewButton = (
    strtolower($status) === 'pending' &&
    strtolower($currentStage) === 'president'
);
?>
<div class="dashboard">
    <div class="dashboard-header" style="display:flex;justify-content:space-between;align-items:center;gap:1rem;flex-wrap:wrap;">
        <div>
            <h1>View Proposal (President)</h1>
            <p>Review the full details and current approval status of this event.</p>
        </div>
