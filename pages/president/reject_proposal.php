...
if (isset($_POST['proposal_id'])) {
    ...
    $query = "UPDATE proposals SET status = 'Rejected', updated_at = NOW() WHERE id = ?";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $notification_message = "Your proposal '".$proposal['title']."' has been REJECTED by the president.";
        ...
        $_SESSION['error'] = "Error rejecting proposal: " . mysqli_error($conn);
    }
