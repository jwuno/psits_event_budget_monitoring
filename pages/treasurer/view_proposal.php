<?php
// pages/treasurer/view_proposal.php
...
<div class="dashboard">
    <div class="dashboard-header">
        <div>
            <h1>View Proposal</h1>
            <p>Review event details and budget before or after endorsement.</p>
        </div>
        <div class="page-actions">
            <a href="pending_reviews.php" class="btn btn-outline btn-sm">
