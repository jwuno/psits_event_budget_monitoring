...
/* Show Review button only if pending on Adviser */
$showReviewButton = (
    strtolower($status) === 'pending' &&
    strtolower($currentStage) === 'adviser'
);
?>
<div class="dashboard">
    <div class="dashboard-header" style="display:flex;justify-content:space-between;align-items:center;gap:1rem;flex-wrap:wrap;">
        <div>
            <h1>View Proposal (Adviser)</h1>
            <p>Review the final details and context before giving final approval or rejection.</p>
        </div>
