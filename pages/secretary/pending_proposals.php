...
// Get pending proposals by this secretary
$query = "SELECT * FROM proposals WHERE created_by = '".$_SESSION['full_name']."' AND status='Pending' ORDER BY date_submitted DESC";
...
<div class="dashboard-container">
    <div class="page-header">
        ...
        <p>Your proposals awaiting president approval</p>
    </div>
    ...
    <div class="empty-state">
        ...
        <p>All your proposals have been processed.</p>
    </div>
    <?php endif; ?>
